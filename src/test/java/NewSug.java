 ...
 * @author Abhishek
 */
public class NewSug extends javax.swing.JFrame {

    /**
     * Creates new form NewSug
     */
    public NewSug() {
        initComponents();
        menu.add(jPanel1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewSug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
